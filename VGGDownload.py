...
parser.add_argument('--dlibFacePredictor', type=str, help="Path to dlib's face predictor.",
                    default=os.path.join(fileDir, "shape_predictor_68_face_landmarks.dat"))
parser.add_argument("--txt", help="VGG's directory of text files of people with images.",
                    default='vgg_face_dataset/files')
parser.add_argument("--raw", help="Directory to save raw images to.",
                    default='/media/tjiang/Elements/ImageClassification/VGG/raw')
parser.add_argument("--aligned", help="Directory to save aligned images to.",
                    default='/media/tjiang/Elements/ImageClassification/VGG/aligned')
